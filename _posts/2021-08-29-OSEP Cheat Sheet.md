...
mermaid: true
image: https://images.credly.com/size/340x340/images/ebefd276-7f47-4aa8-b1d8-4a13636e4851/image.png
---

**The medology described here were "stolen" from [casvancooten](https://casvancooten.com/posts/2020/11/windows-active-directory-exploitation-cheat-sheet-and-command-reference/#lateral-movement-with-rubeus) with few adaptions, so the full credits are not mine**

Original Author: [Cas van Cooten](https://casvancooten.com/)
...
- [Sumário](#sumário)
  - [General](#general)
    ...
    - [PowerShell one-liners](#powershell-one-liners)
      - [Load PowerShell script reflectively](#load-powershell-script-reflectively)
  ...
  - [Lateral Movement](#lateral-movement)
    ...
    - [Kerberoasting](#kerberoasting)
      - [Automatic](#automatic)
      - [Manual](#manual)
      - [Targeted kerberoasting by setting SPN](#targeted-kerberoasting-by-setting-spn)
    - [AS-REP roasting](#as-rep-roasting)
      - [Targeted AS-REP roasting by disabling Kerberos pre-authentication](#targeted-as-rep-roasting-by-disabling-kerberos-pre-authentication)
    ...
    - [Abusing domain trust](#abusing-domain-trust)
      - [Using domain trust key](#using-domain-trust-key)
  ...
  - [Post-Exploitation](#post-exploitation)
    ...
    - [Dumping secrets without Mimikatz](#dumping-secrets-without-mimikatz)
      ...
      - [Dumping secrets from the registry](#dumping-secrets-from-the-registry)
      - [Dumping secrets from a Volume Shadow Copy](#dumping-secrets-from-a-volume-shadow-copy)
...
Note that if you completely compromise a child domain (`currentdomain.targetdomain.com`), you can *by definition* also compromise the parent domain (`targetdomain.com`) due to the implicit trust relationship. The same counts for any trust relationship where SID filtering is disabled (see 'Abusing inter-forest trust').
